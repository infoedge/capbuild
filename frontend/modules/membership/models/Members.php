...
class Members extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['surname', 'gender', 'idNo', 'email', 'phone', 'birthDate'], 'required'],
    ...
    {
        return $this->localChurch0->churchName.'/ '.$this->localChurch0->parish->parishName.' Parish/ '.$this->localChurch0->parish->deanery->deaneryName. ' Deanery';
    }
