...
use backend\modules\projects\models\MembersSearch;
use backend\modules\projects\models\Parish;
use backend\modules\projects\models\Localchurch;
...
class MembersController extends Controller
{
    ...
    {
        $model = $this->findModel($id);
        $model->mybirthdate=$model->birthDate;
        $model->myparish = $model->localChurch0->parishId;
        $model->mydeanery = $model->localChurch0->parish->deaneryId;
