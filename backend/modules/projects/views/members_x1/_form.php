...
<?= $form->field($model, 'phone')->textInput(['maxlength' => true]) ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
<?= $form->field($model, 'mydeanery')->textInput(['maxlength' => true]) ?>
        </div>
        <div class="col-md-4">
<?= $form->field($model, 'myparish')->textInput(['maxlength' => true]) ?>
        </div>
         <div class="col-md-4">
<?= $form->field($model, 'mylocalchurch')->textInput(['maxlength' => true]) ?>
        </div>
    </div>
